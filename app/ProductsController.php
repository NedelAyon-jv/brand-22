	...
	if (isset($_POST['action'])) {
		...
		switch ($_POST['action']) {
			...
			case 'crear_producto':
				...
				$productsController->create($name_var,$slug_var,$description_var,$features_var,$image);
...
class ProductsController 
{
	...
	public function create($name_var,$slug_var,$description_var,$features_var,$image)
	{
